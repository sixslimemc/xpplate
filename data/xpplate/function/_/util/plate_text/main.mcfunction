...
data modify storage xpplate:_ u.plate_text.left set value {text:"", color:white, extra:[]}
data modify storage xpplate:_ u.plate_text.right set value {text:"", color:white, extra:[]}
...
execute if score *plate_text.is_activated _xpplate matches 1 run function xpplate:_/util/plate_text/activated
