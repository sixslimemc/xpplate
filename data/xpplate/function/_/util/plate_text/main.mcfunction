...
data modify storage xpplate:_ u.plate_text.left set value {text:"", color:aqua, extra:[]}
data modify storage xpplate:_ u.plate_text.right set value {text:"", color:aqua, extra:[]}
