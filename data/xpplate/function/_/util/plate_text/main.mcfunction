...
execute if score *plate_text.is_activated _xpplate matches 1 run data modify storage xpplate:_ u.plate_text.left merge value {color:dark_aqua, bold:true}
execute if score *plate_text.is_activated _xpplate matches 1 run data modify storage xpplate:_ u.plate_text.right merge value {color:dark_aqua, bold:true}
