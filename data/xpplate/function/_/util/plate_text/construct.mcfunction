...
data modify storage six:in resolve.text[1] set from storage xpplate:_ u.plate_text.blanks_left
...
data modify storage six:in resolve.text[7] set from storage xpplate:_ u.plate_text.blanks_right
