...
execute if score *plate_text.is_negative _xpplate matches 1 run data modify storage xpplate:_ u.plate_text.right merge value {color:green, bold:true}
execute if score *plate_text.is_negative _xpplate matches 0 run data modify storage xpplate:_ u.plate_text.left merge value {color:light_purple, bold:true}
# execute if score *plate_text.is_negative _xpplate matches 1 run data modify storage xpplate:_ u.plate_text.out_label merge value {color:green, bold:false}
# execute if score *plate_text.is_negative _xpplate matches 0 run data modify storage xpplate:_ u.plate_text.in_label merge value {color:green, bold:false}
