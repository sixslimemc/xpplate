...
execute if score *plate_text.is_negative _xpplate matches 1 run data modify storage xpplate:_ u.plate_text.right merge value {color:dark_green, bold:false}
...
execute if score *plate_text.is_negative _xpplate matches 0 run data modify storage xpplate:_ u.plate_text.left merge value {color:red, bold:false}
