...
scoreboard players operation *take_xp.taking _xpplate += *take_xp.ppoints _xpplate
scoreboard players add *take_xp.taking _xpplate 1

execute store result storage xpplate:_ x.macro.amount int 1 run scoreboard players get *take_xp.ppoints _xpplate
