...
data modify storage floormake:in register.recipes append value {id:"xp_plate", radius:1.2, result:{on_ingredients:"function xpplate:_/main/plate/floormake/on_ingredients", on_catalyst:"function xpplate:_/main/plate/floormake/on_catalyst"}, ingredients:[], pack_id:""}
