...
data modify storage xpplate:config transfer_rates append value {rate:4, threshold_size:30}
data modify storage xpplate:config transfer_rates append value {rate:8, threshold_size:30}