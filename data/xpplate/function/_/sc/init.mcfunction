...
data modify storage xpplate:config transfer_rates set value [{rate:1, threshold_size:20}]
...
data modify storage xpplate:config transfer_rates append value {rate:12, threshold_size:10}