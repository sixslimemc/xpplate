...
execute if score *destroy.stored_xp _xpplate matches 1.. align xyz positioned ~0.5 ~0.1 ~0.5 summon experience_orb run function xpplate:_/main/plate/destroy/xp_orb
