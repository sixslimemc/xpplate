...
execute if score *active.xp_transfer _xpplate matches ..-1 run particle instant_effect{color:16709553} ~ ~0.03 ~ 0.1 0 0.1 1 1 normal
execute if score *active.xp_transfer _xpplate matches 1.. run particle instant_effect{color:15632571} ~ ~0.03 ~ 0.1 0 0.1 1 1 normal
